...
import { useGetProfilePosts } from '../../lib/react-query/queryAndMutation';
...
function Profile() {
  ...
  const { data: postsData, isLoading } = useGetProfilePosts(user.id);
          ...
          <div className="flex-1">
            ...
            <div className="flex flex-col md:flex-row md:items-center gap-4 mb-6">
              ...
              <div className="flex items-center gap-3 w-full md:w-auto">
                ...
                <button className="hidden md:flex items-center justify-center w-11 h-11 bg-gray-800 hover:bg-gray-700 rounded-lg text-light-1">
                  <Settings size={23} />
                </button>
              </div>
            </div>
            ...
            <div className="mb-5">
              ...
              <p className="text-sm leading-tight text-light-2">
                Digital creator ✨<br />
                Building cool things with code<br />
                🇵🇰 Pakistan
              </p>
            </div>
